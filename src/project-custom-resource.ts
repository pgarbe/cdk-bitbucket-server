 ...
 */
export class BitBucketProjectCustomResource extends Construct implements iam.IGrantable {
  /**
  ...
  constructor(scope: Construct, id: string, props: BitBucketProjectCustomResourceProps) {
    super(scope, id);
